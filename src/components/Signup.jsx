...
export default function Signup() {
  return (
    <div className="relative mx-auto w-full max-w-md">
      ...
      >
        <h2 className="text-2xl font-serif">Create your account</h2>
        <p className="mt-1 text-sm text-[hsl(210,15%,95%)]/70">Start your free trial</p>
        <form className="mt-6 space-y-4">
          ...
          <div>
            <label className="text-sm text-[hsl(210,15%,95%)]/70">Confirm Password</label>
            <input type="password" className="mt-1 w-full rounded-xl bg-black/40 border border-[hsl(222,20%,15%)] px-3 py-2 outline-none focus:border-[hsl(155,85%,55%)]/60" placeholder="••••••••" />
          </div>
